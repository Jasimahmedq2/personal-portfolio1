            ...
            <TabPanel>
              <div
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="card lg:max-w-lg shadow-xl" style={{ background: "#082a37" }}>
                  <div className="card-body">
                    <h2 className="card-title text-xl text-yellow-100 font-bold">Front-End development</h2>
                    <p className='text-sm text-white font-bold'>
                    Technology:  html, css, tailwindCss, Bootstrap javascript and React js 
                    </p>
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  className="card lg:max-w-lg bg-base-300 shadow-xl" style={{ background: "#082a37" }}>
                  <div className="card-body">
                    <h2 className="card-title text-xl text-yellow-100 font-bold">Back-End development</h2>
                    <p className='text-sm text-white font-bold'>
                     technology:  node js, express js, mongodb, rest api, cors policy, json web token, pagination
                    </p>
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  className="card lg-max-w-lg bg-base-200 shadow-xl" style={{ background: "#082a37" }}>
                  <div className="card-body">
                    <h2 className="card-title text-xl text-yellow-100 font-bold">full-Stack development</h2>
                    <p className='text-sm text-white font-bold'>
